...
@OnlyIn(Dist.CLIENT)
public class PincodeGuiGuiWindow extends ContainerScreen<PincodeGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	...
	private static final ResourceLocation texture = new ResourceLocation("explodation:textures/pincode_gui.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Bank - Change pincode", 6, 7, -12829636);
		this.font.drawString(ms, "Type to change your pincode", 24, 43, -12829636);
	}
