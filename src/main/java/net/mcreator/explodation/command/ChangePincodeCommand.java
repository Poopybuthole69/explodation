...
package net.mcreator.explodation.command;
...
public class ChangePincodeCommand extends ExplodationModElements.ModElement {
	public ChangePincodeCommand(ExplodationModElements instance) {
		super(instance, 28);
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("changepin")
