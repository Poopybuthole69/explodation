...
import net.mcreator.explodation.procedures.GrapePlantFullPlantRightClickedProcedure;
...
public class GrapePlantFullBlock extends ExplodationModElements.ModElement {
	@ObjectHolder("explodation:grape_plant_full")
	public static final Block block = null;
	public GrapePlantFullBlock(ExplodationModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("grape_plant_full"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("explodation:grape_plant_full"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("grape_plant_full");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GrapesItem.block, (int) (1)));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				GrapePlantFullPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
