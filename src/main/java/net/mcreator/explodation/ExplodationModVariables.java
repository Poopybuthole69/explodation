package net.mcreator.explodation;
...
public class ExplodationModVariables {
	public ExplodationModVariables(ExplodationModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("explodation", "player_variables"), new PlayerVariablesProvider());
	}
